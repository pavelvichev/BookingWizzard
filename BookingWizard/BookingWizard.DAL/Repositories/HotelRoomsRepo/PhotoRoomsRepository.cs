...
{
    public class PhotoRoomsRepository : IPhotoRoomsRepository
    {
        readonly BookingDbContext _context;
        readonly IStringLocalizer<PhotoRoomsRepository> _localizer;

        public PhotoRoomsRepository(BookingDbContext context, IStringLocalizer<PhotoRoomsRepository> localizer)
        {
            _context = context;
