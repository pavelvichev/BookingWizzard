...
{
    public class PhotoHotelsRepository : IPhotoHotelsRepository
    {

        readonly BookingDbContext _context;
        readonly IStringLocalizer<PhotoHotelsRepository> _localizer;

        public PhotoHotelsRepository(BookingDbContext context, IStringLocalizer<PhotoHotelsRepository> localizer)
        {
            _context = context;
